...
CREATE TABLE "Event" (
    ...
    CONSTRAINT "Event_authorId_fkey" FOREIGN KEY ("authorId") REFERENCES "users" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "Category" (
    ...
    "slug" TEXT NOT NULL,
    "eventId" TEXT,
    CONSTRAINT "Category_eventId_fkey" FOREIGN KEY ("eventId") REFERENCES "Event" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
